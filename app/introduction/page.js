...
export default function Introduction() {
    return (
        <div className="flex justify-center w-full flex-col gap-1">
            ...
            <span className="text-sm">
            「精進課程」的構思參考了世界各地的同類課程，它根據中文大學的正式程序運作，內容和考試都經嚴格審核。 每季科目均為大學認可，成功修畢科目的學生，在入讀中文大學學士學位課程時，會獲得2學分。 與此同時，我們更邀請了一群具領導地位的學者， 組成<Link href="advisors" className="text-indigo-500">學術顧問委員會</Link>，負起監察的工作，以確保畢業學生的數學水平達到一定程度， 課程的質素得到國際認同。 <strong>顧問一般是前任或現任著名大學數學系的系主任</strong>，其中包括來自哈佛、MIT、史丹福、牛津等大學的教授、學者。 他們將經常來港為課程講學和指導學生研習，藉著 親身接觸學生來啟迪學生，讓學生的學科知識有所增長，思維能力有所提升。 他們的目標是讓學生的數學修養到達他們任教大學的一年級水平。
            </span>
            <span className="text-sm">
