    ...
    return (
        <div className="flex justify-center w-full flex-col gap-2 sm:text-base text-sm">
            ...
            <table className="table-auto">
                <tbody>
                    <tr>
                        <td className="pr-4 py-1 font-bold align-top">地址 Address</td>
                    ...
                    <tr>
                        <td className="pr-4 py-1 font-bold">電話 Phones</td>
                        <td className="pl-4 py-1">(852) 3943 5295</td>
                    </tr>
                    <tr>
                        <td className="pr-4 py-1 font-bold">傳真 Fax</td>
                        <td className="pl-4 py-1">(852) 2603 5154</td>
                    </tr>
                    <tr>
                        <td className="pr-4 py-1 font-bold">電郵 Email</td>
                        <td className="pl-4 py-1"><Link href="mailto:epymt@math.cuhk.edu.hk" className="text-[#993300]">epymt@math.cuhk.edu.hk</Link></td>
                    </tr>
