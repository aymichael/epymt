    ...
    return (
        <div className="flex justify-center w-full flex-col gap-2">
            ...
            <div className="flex justify-evenly items-center flex-wrap gap-4">
                ...
                {currPage === "teacher" ? <span className="text-black select-none text-lg font-bold">I am a teacher...</span> : <Link href="/faq/teacher" className="text-[#993300] underline">I am a teacher...</Link>}
                {currPage === "parent" ? <span className="text-black select-none text-lg font-bold">I am a parent...</span> : <Link href="/faq/parent" className="text-[#993300] underline">I am a parent...</Link>}
            </div>
            {children}
            </div>
    );
