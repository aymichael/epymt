...
export default function Application() {
    return (
        <div className="flex justify-center w-full flex-col">
            ...
            <span className="text-sm mt-1">1. 登入<Link href="https://cloud.itsc.cuhk.edu.hk/SAYT/Login.aspx" className="text-indigo-500 dark:text-indigo-300">SAYT申請系統</Link>。(首次登入須先以電郵登記帳戶，EPYMT舊生亦須透過有效帳戶登入。)</span>
            <span className="text-sm mb-1">1. Log into <Link href="https://cloud.itsc.cuhk.edu.hk/SAYT/Login.aspx" className="text-indigo-500 dark:text-indigo-300">SAYT Application System</Link>. (For first-time user, please register an account with your email. Even you were former EPYMT student, you still need a valid account to login.)</span>
            ...
            <span className="text-sm mt-1 text-green-500">入學試詳情請參閱<Link href="screening" className="text-indigo-500 dark:text-indigo-300">這裡</Link></span> 
            <span className="text-sm mb-1 text-green-500">For test details, please click <Link href="screening" className="text-indigo-500 dark:text-indigo-300">here</Link></span>
            <br />
