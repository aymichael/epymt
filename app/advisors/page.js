export default function Advisors() {
    return (
        <div className="flex justify-center w-full flex-col gap-2">
            <span className="font-bold text-lg font-serif">初始學術顧問委員 Inaugurate Advisors</span>
            ...
            <div className="flex justify-center">
                <table className="w-3/4 table-auto border border-collapse border-black font-serif text-sm">
                    <thead>
                        <tr className="border border-black bg-[#bdab79]">
                            <th className="text-left px-2 py-1">NAME</th>
                            <th className="text-left px-2 py-1">ORGANIZATION</th>
                        </tr>
                    </thead>
                    <tbody>
                        <tr className="border border-black bg-[#f0e0c0]">
                            <td className="px-2 py-1">Prof. Philip Candelas</td>
                            <td className="px-2 py-1">Oxford University</td>
                        </tr>
                        <tr className="border border-black bg-[#e0d0b0]">
            ...
            <span className="text-xs font-serif">
                * We are deeply saddened to learn that Prof. J. H. Coates, passed away in May 2022. He will always be remembered for his great contributions to our programme.
            </span>
        </div>
    );
}