...
export default function Courses() {
    return (
        <div className="flex justify-center w-full flex-col gap-2">
                ...
                <tbody>
                    ...
                    <tr>
                        ...
                        <td className="px-2 py-2 border border-black bg-[#F0E0C0]">
                            <div className="flex flex-col gap-1">
                                <span><Link href="/application" className="text-[#993300]">網上申請</Link>(包括申請步驟及入學試詳情)</span>
                                <span><Link href="/application" className="text-[#993300]">Online Application</Link>(with steps and admission test details)</span>
                            </div>
                        </td>
                    </tr>
                    <tr>
                        ...
                        <td className="px-2 py-2 border border-black bg-[#F0E0C0]">
                            <div className="flex flex-col gap-1">
                                <span>請參閱<Link href="#leaflet" className="text-[#993300]">課程海報單張</Link>及上述各科網頁</span>
                                <span>Please refer to the <Link href="#leaflet" className="text-[#993300]">programme poster and leaflet</Link> and course pages above</span>
                            </div>
                        </td>
                    </tr>
                    <tr>
                    ...
                    <tr>
                        ...
                        <td className="px-2 py-2 border border-black bg-[#F0E0C0]">
                            <div className="flex flex-col gap-1">
                                ...
                                <span>For every Yau Science Award team that has submitted a complete Mathematics project, each team member will receive a deduction of HK$1,500 in the tuition for the EPYMT program on top of the current scholarship. Details could be found at <Link href="https://yashk.org.hk/yau-award" className="text-[#993300]">https://yashk.org.hk/yau-award</Link>**</span>
            ...
            <span className="text-lg font-bold" name="leaflet">課程海報單張</span>
