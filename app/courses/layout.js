    ...
    return (
        <div className="flex justify-center w-full flex-col gap-2">
            <div className="flex justify-evenly items-center flex-wrap gap-4">
                ...
                {currPage === "past-courses" ? <span className="text-black select-none text-lg font-bold">往期課程</span> : <Link href="/courses/past-courses" className="text-[#993300] underline">往期課程</Link>}
                {currPage === "student-awards" ? <span className="text-black select-none text-lg font-bold">學生獎項</span> : <Link href="/courses/student-awards" className="text-[#993300] underline">學生獎項</Link>}
            </div>
