...
export default function Screening() {
    return (
        <div className="flex justify-center w-full flex-col text-base">
            ...
            <span>2. Please add our email address (<Link href="mailto:epymt@math.cuhk.edu.hk" className="text-indigo-500">epymt@math.cuhk.edu.hk</Link>) into your address book so that our message will not be moved to junk mails.</span>
            ...
            <span>2. Please return your answers from 00:00 to 23:59 on 11 June (next Tuesday) by email to <Link href="mailto:epymt@math.cuhk.edu.hk" className="text-indigo-500">epymt@math.cuhk.edu.hk</Link>.</span>
            <br />
            <span className="text-sm">Enquiries: <Link href="mailto:epymt@math.cuhk.edu.hk" className="text-indigo-500">epymt@math.cuhk.edu.hk</Link></span>
