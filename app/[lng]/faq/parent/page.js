        ...
        <div className="flex flex-col gap-4">
            ...
            <QuestionBox
                ...
                answer={
                    ...
                    </div>, <div className="flex flex-col gap-2" key="1"> <p>我們有多個不同程度的課程供學生選擇。一般而言，如果學生是中三或以上，喜歡數學並且是班上較優秀的學生，應該有適合他的課程。如果他是低年級但已具備高年級的數學能力，他也可以根據以下程度找到合適的課程。</p>
                            ...
                            <table className="table-auto w-full text-left">
                                ...
                                <tbody>
                                    ...
                                    <tr className="border-t border-gray-400">
                                        ...
                                        <td className="px-2 py-2">中六頂尖學生或曾修讀 EPYMT 的學生</td> <td className="px-2 py-2">- 最具挑戰性的課程；絕大多數中四學生難以應付</td>
                                    </tr>
                                </tbody>
                            </table>
                        </div>
                        <span>建議先向學校老師諮詢，以決定最適合他/她的課程，並請老師或校長為他/她撰寫線上推薦信。我們也會透過入學甄選測驗來評估申請者的數學能力，再決定是否錄取。</span> 
                        <span>課程詳情與報名，請參閱 <Link href="/zh-Hant/course-information" className="text-indigo-500 dark:text-indigo-300">此處</Link>。</span> </div>]
                }
            />
            <QuestionBox
                lang={lng}
            ...
            <QuestionBox
                ...
                <span key="1">通常，我們會邀請大多數申請者在<Link href="/zh-Hant/application" className="text-indigo-500 dark:text-indigo-300">申請</Link>頁面中提到的日期參加入學甄選測驗。我們也會在申請期結束後向學生發送確認電子郵件。請讓你的孩子持續檢查他/她的電子郵件。</span>
                ]}
            />
            <QuestionBox
                lang={lng}
