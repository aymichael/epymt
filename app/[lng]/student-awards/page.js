...
export default function StudentAwards(){
    ...
    return (
        <div className="flex justify-center w-full flex-col gap-2 md:text-base/8 sm:text-sm/8 text-xs">
            ...
            <span className="font-bold text-lg/8">得獎學生名單 List of Student Awards</span>
            <table className="table-auto text-base/8">
                <tbody>
                    {years.reverse().slice(0,-1).map((year,idx) => (
                        <tr key={idx}>
                            ...
                            <td className="p-2">
                                ...
                                <span className= "cursor-default select-none underline">名單 List</span>
                            </td>
                        </tr>
                    ))}
                </tbody>
