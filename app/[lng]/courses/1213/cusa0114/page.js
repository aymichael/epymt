...
export default async function Course({ params }) {
    ...
    return (
        <div className="flex justify-center w-full flex-col gap-1">
            <span className="text-3xl font-bold text-center">CUSA0114 Enrichment Mentoring Mathematics II 數學啟導修習 II</span>
            ...
            <table className="table-auto border-collapse text-sm md:text-base border-gray-200 dark:border-gray-600">
                ...
                <tbody>
                    <tr>
                        <td className="border p-2">2012年11月10日 (六)</td>
                        <td className="border p-2">上午9:30–中午12:00</td>
                        <td className="border p-2">李兆基樓301室</td>
                        <td className="border p-2">教學，解題，討論</td>
                    </tr>
                    <tr>
                        <td className="border p-2">2012年12月1日 (六)</td>
                        <td className="border p-2">上午9:30–中午12:00</td>
                        <td className="border p-2">李兆基樓301室</td>
                        <td className="border p-2">教學，解題，討論</td>
                    </tr>
                    <tr>
                        <td className="border p-2">2012年12月22日 (六)</td>
                        <td className="border p-2">上午9:30–中午12:00</td>
                        <td className="border p-2">李兆基樓301室</td>
                        <td className="border p-2">教學，解題，討論</td>
                    </tr>
                    <tr>
                        <td className="border p-2">2013年1月12日 (六)</td>
                        <td className="border p-2">上午9:30–中午12:00</td>
                        <td className="border p-2">李兆基樓301室</td>
                        <td className="border p-2">教學，解題，討論</td>
                    </tr>
                    <tr>
                        <td className="border p-2">2013年2月16日 (六)</td>
                        <td className="border p-2">上午9:30–中午12:00</td>
                        <td className="border p-2">李兆基樓301室</td>
                        <td className="border p-2">教學，解題，討論</td>
                    </tr>
                    <tr>
                        <td className="border p-2">2013年3月16日 (六)</td>
                        <td className="border p-2">上午9:30–中午12:00</td>
                        <td className="border p-2">李兆基樓301室</td>
                        <td className="border p-2">教學，解題，討論</td>
                    </tr>
                    <tr>
                        <td className="border p-2">2013年4月13日 (六)</td>
                        <td className="border p-2">上午9:30–中午12:00</td>
                        <td className="border p-2">李兆基樓301室</td>
                        <td className="border p-2">教學，解題，討論</td>
                    </tr>
                    <tr>
                        <td className="border p-2">2013年5月11日 (六)</td>
                        <td className="border p-2">上午9:30–中午12:00</td>
                        <td className="border p-2">李兆基樓301室</td>
                        <td className="border p-2">教學，解題，討論</td>
                    </tr>
                    <tr>
                        <td className="border p-2">2013年6月8日 (六)</td>
                        <td className="border p-2">上午9:30–中午12:00</td>
                        <td className="border p-2">李兆基樓301室</td>
                        <td className="border p-2">教學，解題，討論</td>
                    </tr>
                    <tr>
                        <td colSpan="4" className="border p-2 text-center">
                            學員將獲邀參予於1月19日、4月20日、6月15日舉行的講座及其他公開活動。
                        </td>
                    </tr>
                </tbody>
            </table>
