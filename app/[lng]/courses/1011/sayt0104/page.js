...
export default async function Course({ params }) {
    ...
    return (
        <div className="flex justify-center w-full flex-col gap-1">
            <span className="text-3xl font-bold text-center mb-4">SAYT0104 Enrichment Mentoring Mathematics I 數學啟導修習 I</span>
            ...
            <ul className="list-disc list-inside my-4">
                <li>中文大學課程編號：SAYT0104</li>
                <li>馮馮漢柱資優教育中心編號：201011-MATHE-1 數學優才培育計劃</li>
            </ul>
            <span>上課日期、時間、地點：</span>
            <span>所有課堂將於<strong>香港中文大學邵逸夫夫人樓地下C2室</strong>舉行，安排如下:</span>
            <table className="table-auto border-collapse text-sm md:text-base border-gray-200 dark:border-gray-600">
                ...
                <tbody>
                    <tr>
                        <td className="border p-2">2010年11月6日 (六)</td>
                        <td className="border p-2">下午2:00 – 4:00</td>
                        <td className="border p-2">課程安排與講座</td>
                    </tr>
                    <tr>
                        <td className="border p-2">2010年11月20日 (六)</td>
                        <td className="border p-2">上午9:30 – 中午12:00</td>
                        <td className="border p-2">教學，解題，討論，電算</td>
                    </tr>
                    <tr>
                        <td className="border p-2">2011年1月8日 (六)</td>
                        <td className="border p-2">上午9:30 – 中午12:00</td>
                        <td className="border p-2">講座</td>
                    </tr>
                    <tr>
                        <td className="border p-2">2011年2月12日 (六)</td>
                        <td className="border p-2">上午9:30 – 中午12:00</td>
                        <td className="border p-2">教學，解題，討論，電算</td>
                    </tr>
                    <tr>
                        <td className="border p-2">2011年3月5日 (六)</td>
                        <td className="border p-2">上午9:30 – 中午12:00</td>
                        <td className="border p-2">教學，解題，討論，電算</td>
                    </tr>
                    <tr>
                        <td className="border p-2">2011年4月2日 (六)</td>
                        <td className="border p-2">上午9:30 – 中午12:00</td>
                        <td className="border p-2">講座</td>
                    </tr>
                    <tr>
                        <td className="border p-2">2011年4月30日 (六)</td>
                        <td className="border p-2">上午9:30 – 中午12:00</td>
                        <td className="border p-2">教學，解題，討論，電算</td>
                    </tr>
                    <tr>
                        <td className="border p-2">2011年5月14日 (六)</td>
                        <td className="border p-2">上午9:30 – 中午12:00</td>
                        <td className="border p-2">教學，解題，討論，電算</td>
                    </tr>
                    <tr>
                        <td className="border p-2">2011年5月28日 (六)</td>
                        <td className="border p-2">上午9:30 – 中午12:00</td>
                        <td className="border p-2">教學，解題，討論，電算</td>
                    </tr>
                </tbody>
            ...
            <table className="table-auto border-collapse text-sm md:text-base border-gray-200 dark:border-gray-600">
                <tbody>
                    <tr>
                        <td className="border p-2">2011年6月4日(六)</td>
                        <td className="border p-2">上午09:30–中午12:00*</td>
                        <td className="border p-2">考核</td>
                    </tr>
                </tbody>
            </table>
            <span className="mb-4">*在得到學生共識下，上課時間可作更改。</span>
            ...
            <table className="border-collapse text-base md:text-lg mb-4">
                <tbody>
                    ...
                    <tr>
                        ...
                        <td className="p-2">張一鳴先生</td>
                    </tr>
                    <tr>
                        <td className="font-bold">助理導師</td>
                        <td className="p-2">三位本科大學生</td>
                    </tr>
                </tbody>
            </table>
