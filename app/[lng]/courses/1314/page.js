...
const date =
    ["12/7, 15/7, 17/7, 19/7, 22/7, 24/7, 26/7, 29/7, 31/7",
        "1/8, 5/8, 7/8, 9/8, 12/8, 14/8, 16/8, 19/8, 21/8",
        "12/7, 15/7, 17/7, 19/7, 22/7, 24/7, 26/7, 29/7, 31/7",
        "29/5, 3/6, 5/6, 7/6, 10/6, 14/6, 17/6, 19/6, 21/6"
    ];
const examDate = ["2/8", "23/8", "2/8", "24/6"];
const lecturerCHI = ["陳啟良先生(香港中文大學)", "李俊捷博士(香港中文大學)", "劉智軒博士(香港中文大學)", "溫有恒教授(香港中文大學)"];
const lecturerENG = ["Mr. Chan Kai Leung (CUHK)", "Dr. Li Chun Che Charles (CUHK)", " Dr. Lau Chi Hin (CUHK)", "Prof. WAN Yau Heng Tom (CUHK)"];
const tuitionFee = "3,000";
const scholarshipAmount = "700";
