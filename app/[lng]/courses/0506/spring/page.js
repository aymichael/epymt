    ...
    return (
        <div className="flex justify-center w-full flex-col gap-1">
            ...
            <div className="flex flex-col gap-1 my-4">
                <span>
                    要接受真正的數學訓練，培養邏輯的思考方式，學習「數學分析」是絕佳的途徑。 正是由於這樣，世界主流大學的數學系都會把「數學分析」訂為主修生的必修科目。 「數學英才精進課程」將於2006年2月11日推出「數學分析」春季班，向有興趣的同學介紹數學分析這門準確精密，影響深遠的學科。 課程專為預科學生而設，不要求高等數學作預備知識。 多位聞名世界的學者，將應邀為春季班的同學主持講座。 我們希望同學在專家學者的親身指導下，眼界得以開闊，潛能得以啟發，對他們日後將有深遠的影響。
                </span>
                <span>
                    在春季班表現良好的學生，可優先入讀2006-07年的<Link href="summer" className=" text-indigo-500">暑期班</Link>。
                </span>
            </div>
            ...
            <table className="my-4">
                <tbody>
                    ...
                    <tr className="md:border-b border-0 border-gray-200 dark:border-gray-500 md:table-row flex flex-col">
                        ...
                        <td className="align-top flex flex-col gap-2 md:px-4 md:py-4 dark:md:bg-gray-600 md:bg-gray-50 md:pb-4 pb-6">
                            <span>2006年2月11日至4月29日期間於香港中文大學上課。</span>
                            <span>基本課和講座：逢星期六上午。</span>
                            <span>導修討論班：星期六下午或星期二傍晚。</span>
                        </td>
                    </tr>
                    <tr className="md:border-b border-0 border-gray-200 dark:border-gray-500 md:table-row flex flex-col">
                        <td className="font-bold align-top text-xl/8 md:w-1/4 md:bg-gray-100 md:dark:text-white md:dark:bg-gray-800 md:px-4 md:py-4 md:border-0 border-b-2">
            ...
            <div className="overflow-x-auto mt-4 mb-2">
                <table className="w-full border whitespace-nowrap border-gray-300">
                    <tbody>
                        ...
                        <tr className="odd:bg-white even:bg-gray-50 dark:odd:bg-gray-900 dark:even:bg-gray-800 border-b border-gray-200 dark:border-gray-700">
                            <td className="px-4 py-2 border-b">陳漢夫教授</td>
                            <td className="px-4 py-2 border-b">香港中文大學</td>
                        </tr>
                        <tr className="odd:bg-white even:bg-gray-50 dark:odd:bg-gray-900 dark:even:bg-gray-800 border-b border-gray-200 dark:border-gray-700">
                            <td className="px-4 py-2 border-b">Prof. Cho-ho Chu</td>
                            <td className="px-4 py-2 border-b">Queen Mary College, London University, U.K.</td>
                        </tr>
                        <tr className="odd:bg-white even:bg-gray-50 dark:odd:bg-gray-900 dark:even:bg-gray-800 border-b border-gray-200 dark:border-gray-700">
                            <td className="px-4 py-2 border-b">Prof. Marco Gualtieri</td>
                            <td className="px-4 py-2 border-b">M.I.T., U.S.A.</td>
                        </tr>
                        <tr className="odd:bg-white even:bg-gray-50 dark:odd:bg-gray-900 dark:even:bg-gray-800 border-b border-gray-200 dark:border-gray-700">
                            <td className="px-4 py-2 border-b">Prof. Spiro Karigiannis</td>
                            <td className="px-4 py-2 border-b">Michigan State University, U.S.A.</td>
                        </tr>
                        <tr className="odd:bg-white even:bg-gray-50 dark:odd:bg-gray-900 dark:even:bg-gray-800 border-b border-gray-200 dark:border-gray-700">
                            <td className="px-4 py-2 border-b">Prof. Justin Wan</td>
                            <td className="px-4 py-2 border-b">University of Waterloo, Canada</td>
                        </tr>
                        <tr className="odd:bg-white even:bg-gray-50 dark:odd:bg-gray-900 dark:even:bg-gray-800 border-b border-gray-200 dark:border-gray-700">
                        ...
                        <tr className="odd:bg-white even:bg-gray-50 dark:odd:bg-gray-900 dark:even:bg-gray-800 border-b border-gray-200 dark:border-gray-700">
                            <td className="px-4 py-2 border-b">劉智軒博士</td>
                            <td className="px-4 py-2 border-b">香港中文大學</td>
                        </tr>
                    </tbody>
                </table>
