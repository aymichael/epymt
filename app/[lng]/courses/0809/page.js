...
const courses = ["tdg", "cnneg"];
const lecturerCHI = ["溫有恒教授(香港中文大學)", "張亮夫博士(香港中文大學)","朱順賢博士(香港中文大學)"];
const lecturerENG = ["Prof. WAN Yau Heng Tom (CUHK)", "Dr. CHEUNG Leung Fu (CUHK)","Dr. ZHU Shun Xian (CUHK)"];
...
export default async function Course({ params }) {
    ...
    const date = lng === "en" ? [
        "(preparatory)3th, 4th, 7th, 8th July, 2008; 14th July-8th August, 2008, every Mon, Wed and Fri",
        "14th July-8th August, 2008, every Mon, Wed and Fri",
    ] : [
        "(先修課)2008年7月3, 4, 7, 8日；2008年7月14日至8月4日逢星期一、三、五",
        "2008年7月14日至8月4日逢星期一、三、五",
    ];
    return (
                ...
                <tbody>
                    ...
                    <tr className="md:table-row flex flex-col">
                        ...
                        <td className="md:px-4 md:py-4 flex flex-col gap-1 dark:md:bg-gray-600 md:bg-gray-50 md:pb-4 pb-6">
                            ...
                            />
                            <span>{lng === "en" ? "- All students who pass a second or additional course will receive a scholarship of HK$1,200 per course" : "- 所有同學在合格完成第二個或以上科目時，每科均可得獎學金1200元"}</span>
                        </td>
                    </tr>
                </tbody>
            </table>
